 ...
 * generated in the com.shenk.accrecord.ws.client package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://service.ws.accrecord.shenk.com/", "queryWeatherResponse");
    private final static QName _QueryWeather_QNAME = new QName("http://service.ws.accrecord.shenk.com/", "queryWeather");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.shenk.accrecord.ws.client
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.ws.accrecord.shenk.com/", name = "queryWeatherResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.ws.accrecord.shenk.com/", name = "queryWeather")
