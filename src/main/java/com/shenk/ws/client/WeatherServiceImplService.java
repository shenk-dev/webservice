 ...
 * 
 */
@WebServiceClient(name = "WeatherServiceImplService", targetNamespace = "http://service.ws.accrecord.shenk.com/", wsdlLocation = "http://127.0.0.1:8888/weather?wsdl")
    ...
    extends Service
{
    ...
    private final static QName WEATHERSERVICEIMPLSERVICE_QNAME = new QName("http://service.ws.accrecord.shenk.com/", "WeatherServiceImplService");
    ...
    public WeatherServiceImpl getWeatherServiceImplPort() {
        return super.getPort(new QName("http://service.ws.accrecord.shenk.com/", "WeatherServiceImplPort"), WeatherServiceImpl.class);
    }
    ...
    public WeatherServiceImpl getWeatherServiceImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://service.ws.accrecord.shenk.com/", "WeatherServiceImplPort"), WeatherServiceImpl.class, features);
    }
